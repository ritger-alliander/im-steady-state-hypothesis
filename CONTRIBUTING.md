# Contributing to im-steady-state-hypothesis

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-steady-state-hypothesis. These guidelines are not strict rules.
...
The im-steady-state-hypothesis team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-steady-state-hypothesis technical leads
...
[issues]: https://github.com/ritger-alliander/im-steady-state-hypothesis/issues/
[pulls]: https://github.com/ritger-alliander/im-steady-state-hypothesis/pulls/
